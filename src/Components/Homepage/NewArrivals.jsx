        ...
        <section id="newarrivals" className="bg-gray-100 ">
            <div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 p-3 ">
                    {items.map((item) => (
                        <div key={item.id} className="relative group h-70 lg:h-full bg-gray-300 rounded-2xl p-2 overflow-hidden">
                ...
                <div className="grid justify-items-center p-6 pb-10">
                    <button className="bg-emerald-900 text-sm  rounded-lg p-2 text-white font-medium cursor-pointer">View More...</button>
                </div>
